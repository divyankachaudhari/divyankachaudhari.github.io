...
So what exactly has happened? So many discussions around. This is actually an interesting topic (Update: Cloudfare wrote an [article](https://blog.cloudflare.com/during-the-facebook-outage/) about this, highly recommended). 
